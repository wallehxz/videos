...
group :development, :test do
  ...
  gem 'pry-nav', '0.2.4'
  gem 'pry-doc', '0.6.0'
  gem 'rspec-rails', '3.1.0'  # http://www.rubydoc.info/gems/rspec-rails/frames 项目测试
  gem 'guard-rspec', '4.5.0' #automatically run your specs
end
