...
module ApplicationHelper
  ...
  def user_avatar(user)
    if user.user_detail.avatar.present?
      return user.user_detail.avatar
    else
  ...
  def user_name(user)
    if user.user_detail.nick_name.present?
      return user.user_detail.nick_name
    else
      return user.email
    end
  end
